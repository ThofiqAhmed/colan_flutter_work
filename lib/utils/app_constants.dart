...
class AppConstants {
  ...
  static const String KEY_CUSTOMER_MAIL_ID = 'customer_mail_id';
  ...
  static const String IMAGE_PROFILE_PROTOCOL = 'Image size should be 256x256'; // min 150x110
  ...
  static const String DRAWER_ITEM_BEAUTY_AND_PERSONAL_CARE = "Beauty & Personal Care";
  ...
  static const String ARE_YOU_SURE_CANCEL_ORDER = 'Are you sure to cancel this order?';
  ...
  static const String THANKS_SHOPPING_TEXT_1 = 'Thanks for shopping! Your order ';
  ...
  static const String YOUR_SHOPPING_CART_IS_EMPTY = 'Your shopping cart is empty.';
  static const String YOU_HAVE_ADD_ITEMS_SAVED_TO_BUY_LATER = 'You have items saved to buy later.'
