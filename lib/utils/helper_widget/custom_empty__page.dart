...
class CustomEmptyScreen extends StatelessWidget {
  ...
  CustomEmptyScreen(this.imagePath, this.shortDescription, this.description, this.buttonText, this.context,
      {@required this.onPressesButton});
  ...
  Widget _buildContent(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          shortDescription,
          style: getStyleSubHeading(context).copyWith(fontWeight: AppFont.fontWeightSemiBold, color: colorBlack),
          textAlign: TextAlign.center,
        ),
        _verticalSpace(12.0),
        Text(
          description,
          style: getStyleCaption(context).copyWith(color: colorDarkGrey, height: 1.5),
          textAlign: TextAlign.center,
        ),
        Container(
