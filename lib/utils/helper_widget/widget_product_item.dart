...
import 'package:flutter_sample_code/core/model/item_product_model.dart';
...
//                              child: Image.asset(itemProduct.imageUrl),
                                child: (itemProduct.imageUrl != null && itemProduct.imageUrl != "")
                                    ? CachedNetworkImage(imageUrl: itemProduct.imageUrl)
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: FloatingActionButton(
                                  ...
                                  elevation: 2.0,
                                  onPressed: () => onPressedIconHeart(itemProduct),
                                  mini: true,
                                  backgroundColor: colorWhite,
                                  child: Consumer<ItemProduct>(
                                    builder: (context, value, _) => value.isFavourite
              ...
              Padding(
                ...
                child: Align(
                  child: (itemProduct.specialPrice == null || itemProduct.specialPrice == 0.0)
                      ? Text(
                      ...
                      : Row(
                          children: <Widget>[
                            ...
                            Text(
                              ...
                              style: getStyleCaption(context).copyWith(decoration: TextDecoration.lineThrough),
                            )
                          ],
                        ),
                  alignment: Alignment.centerLeft,
              ...
              Padding(
                  ...
                  child: isCompareModeOn
                      ? _buildCompareModeOption(itemProduct, context, onPressedItemCompareButton)
                      : _buildAddRemoveQuantityOption(itemProduct, onPressedRemove, onPressedAdd)),
            ],
          ),
        ),
      ),
...
Widget _buildCompareModeOption(itemProduct, context, onPressedItemCompareButton) {
      ...
      child: RaisedButton(
        ...
        child: Text(
          ...
          style: getStyleBody1(context).copyWith(
              color: !value.isAddedToCompare ? colorWhite : colorPrimary, fontWeight: AppFont.fontWeightSemiBold),
        ),
        onPressed: () => onPressedItemCompareButton(value),
...
Widget _buildAddRemoveQuantityOption(ItemProduct itemProduct, onPressedRemove, onPressedAdd) {
  return Row(
    children: <Widget>[
      Expanded(
