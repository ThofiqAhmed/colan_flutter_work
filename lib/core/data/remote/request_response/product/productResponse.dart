class ProductResponse {
  ...
  ProductResponse.fromJson(Map<String, dynamic> json) {
    ...
    searchCriteria = json['search_criteria'] != null ? new SearchCriteria.fromJson(json['search_criteria']) : null;
...
class SearchCriteria {
  ...
  SearchCriteria({this.filterGroups, this.sortOrders, this.pageSize, this.currentPage});
