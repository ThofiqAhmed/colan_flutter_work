class AppUrl {
  static final baseHost = "staging.sample.colan.app";
  ...
  //AdminToken
  static final pathAdminToken = "/rest/default/V1/integration/admin/token"; //POST
  //forgotPwdApiLink
  ...
  static final pathCategoryCustomList = '/rest/V1/shopkeeper/CategoryCustomList'; //GET
  //top distributor list
  static final pathTopDistributorList = '/rest/V1/shopkeeper/DistributorList'; //GET
  //getProducts
  ...
  //getCartList
  static final pathCartList = "/rest/V1/shopkeeper/CartCustomList?quoteId="; // Get
  //getCartAdd
  ...
  static final shippingMethods = "/rest/default/V1/carts/mine/estimate-shipping-methods/"; //POST
  // set shipping methods
  static final setShippingMethods = "/rest/V1/carts/mine/shipping-information"; //POST
  // get cart total
  ...
  // All distributor api
  static final pathAllDistributor = "/rest/V1/shopkeeper/DistributorAllList"; // GET
  //contactUs details
  ...
  static final pathAddProductsToCompare = "/rest/V1/add-product-to-compare"; //POST
  // Remove Products from compare
  static final pathRemoveProductsFromCompare = "/rest/V1/compare-product-remove?product_id="; //DELETE
  ...
  //postProfileImage
  static final postProfileImage = "/shopowner/apiCustomer/Customerprofile"; //POST
  //postTotalInformation for Cart totals
  static final postTotalInformation = "/rest/default/V1/carts/mine/totals-information"; //POST
  //postPaymentInformation for Payment
  static final postPaymentInformation = "/rest/default/V1/carts/mine/payment-information"; //POST
  // change password
