...
import 'package:flutter_sample_code/utils/app_text_style.dart';
...
class BaseNotifier extends ChangeNotifier {
  ...
  String convertToDecimal(String value, int count) {
    return (value != null && value != "" && value != 'null') ? double.parse(value).toStringAsFixed(count) : "";
  }
  ...
  void showToast(String message) {
    try {
      if (message.isNotEmpty) {
        Toast.show(message, this.context, duration: Toast.LENGTH_SHORT, gravity: Toast.BOTTOM);
      } else {
        log.e('server message is NULL | EMPTY');
      }
    } catch (e) {
